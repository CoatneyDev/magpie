...
export class SortingService {
  ...
  // https://github.com/jefelewis/algorithms-review/blob/master/search-algorithms/binary-search.js
  // Only works on Sorted Arrays (e.g: Dictionary)
  binarySearch(array,target): any{
    let startIndex =0;
